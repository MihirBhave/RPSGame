...
class AuthScreen(tk.Frame):
    ...
    def show_login(self):
        signup_label = tk.Label(self, text="Login to start the game!", bg='#05e8d5', fg="#080a0a", font=("Arial", 25))
        signup_label.pack(pady=80)
 
        username_label = tk.Label(self, text="Username:", font=("Helvetica", 12),bg='#05e8d5', fg="#080a0a")
        username_label.pack(pady=5)
 
        username_entry = tk.Entry(self, font=("Helvetica", 12))
        username_entry.pack(pady=5)
 
        password_label = tk.Label(self, text="Password:", font=("Helvetica", 12),bg='#05e8d5', fg="#080a0a")
